...
export const registerUserThunk = createAsyncThunk('auth/register', async(user, thunkAPI) => {
    try {
...
export const loginUserThunk = createAsyncThunk('auth/login', async(user, thunkAPI) => {
    try {
